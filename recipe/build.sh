...
if [[ "$CONDA_BUILD_CROSS_COMPILATION" == "1" ]]; then
  EXTRA_CMAKE="-DCDEFS=Add_ -DMPI_C_LIB_NAMES=$PREFIX/lib/libmpi$SHLIB_EXT -DMPI_C_WORKS=TRUE -DMPI_Fortran_LIB_NAMES=$PREFIX/lib/libmpifort$SHLIB_EXT -DMPI_Fortran_WORKS=TRUE"
